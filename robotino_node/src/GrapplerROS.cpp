...
{
	grappler_readings_pub_ = nh_.advertise<robotino_msgs::GrapplerReadings>("grappler_readings", 1, true);
	grappler_store_pub_ = nh_.advertise<robotino_msgs::GrapplerReadings>("grappler_store_positions", 1, false);
...
void GrapplerROS::setGrapplerAxes( const robotino_msgs::SetGrapplerAxesConstPtr& msg)
{
...
void GrapplerROS::setGrapplerAxis( const robotino_msgs::SetGrapplerAxisConstPtr& msg)
{
	int axis = msg->axis;
	int angle = msg->angle;
